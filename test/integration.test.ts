...
describe('BridgeToNative integration testing', () => {
    ...
    describe('iOS environment', () => {
        it.skip('should use AM interface correctly when moving forward and then backward', async () => {
            const inst = new BridgeToNative(mockedHandleRedirect, '/', {
                ...defaultAmParams,
                title: 'Initial Title',
            });
        ...
        it.skip('should act and use AM interface correctly when using `goBackAFewSteps`', async () => {
            const inst = new BridgeToNative(mockedHandleRedirect, '/', defaultAmParams);
            const mockedCloseWebview = jest.fn();
        ...
        it.skip('should act and use AM interface correctly when using `setInitialView`', async () => {
            const inst = new BridgeToNative(mockedHandleRedirect, '/', defaultAmParams);
            const mockedCloseWebview = jest.fn();
